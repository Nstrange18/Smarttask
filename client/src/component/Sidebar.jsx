...
const Sidebar = () => {
  return (
    <div className="group absolute top-0 bg-brand hover:w-50 transition-all duration-500 ease-in-out h-full w-20 p-4 z-1000 hover:backdrop-blur-4xl rounded-tr-btn rounded-br-btn shadow-xl flex flex-col items-center">
      ...
      >
        <div className="flex flex-col items-center cursor-pointer gap-1 hover:gap-2 transition-all duration-300">
          ...
          {/* LOGOUT text already visible, so no change needed here */}
